...
Findings and synthesized reports — one file per finding or report, dated. Raw notes-in-progress can live here too, but promote anything conclusive out of draft form before calling it done.
