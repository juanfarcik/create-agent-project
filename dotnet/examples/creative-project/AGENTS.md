...
# creative-project — Agent Instructions

This is a **creative** project. Architecture: **collaborative**.
...
- `creative-director` (always, balanced) — Maintains creative vision and coherence across creative work.
